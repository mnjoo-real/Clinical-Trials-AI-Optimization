export const translations = {
  en: {
    ...
    ai_lock: "Lock",
    ai_locked: "Locked",
    ai_optimized_title_locked: "AI-Optimized Design (Respecting Locked Parameters)",
    ai_constraint_note:
      "This system performs constraint-based optimization. Researchers can lock specific design parameters that must remain unchanged, and the AI adjusts only the remaining variables to improve efficiency while preserving essential clinical requirements.",
    ai_optimized_title: "AI-Recommended Optimized Trial Design",
    ...
    ai_label_efficiency: "Efficiency Score:",
  ...
  ko: {
    ...
    ai_constraint_note:
      "이 시스템은 제약 조건 기반 최적화를 수행합니다. 연구자는 변경되면 안 되는 설계 파라미터를 잠글 수 있으며, AI는 나머지 변수만 조정해 임상 요구사항을 유지하면서 효율을 개선합니다.",
    ai_optimized_title: "AI 추천 최적화 임상 설계",
    ...
    ai_label_cost: "추정 비용:",
    ai_label_efficiency: "효율성 점수:",
    ai_efficiency_unit: "지수",
    ai_optimized_note:
      "AI 최적화 설계는 평가 지표 선택, 눈가림 전략, 표본 수, 기간 등 핵심 임상 파라미터를 조정해 자동 생성됩니다. 이는 AI가 임상 성공 확률을 유지하면서 더 높은 효율을 달성할 수 있는 대안 구성을 탐색하는 연구 접근을 반영합니다.",
    ai_modal_close: "닫기",
